...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <section id="youtube">
                <h3>youtube video</h3>
                <iframe width="800" height="400" src="https://www.youtube.com/embed/JIklRSR0ov4?rel=0&autoplay=1&mute=1">
                </iframe>
                ...
                <ol>
                    <li class="oddList">
                        ...
                        <aside class="flexbox-layout">
                            ...
                            <figure>
                                <img class="rounded" alt="plastic" src="image/plastic.jpg">
                    ...
                    <li class="evenList">
                        ...
                        <aside class="flexbox-layout">
                            <figure>
                                <img class="rounded" alt="recycle" src="image/recycle.jpeg">
