            ...
            <article class="grid-layout">
                ...
                <aside id="picIntroduction">
                    <figure class="left" id="explanation1">
                        <img class="rounded" alt="turtle eating plastic bag" src="image/turtle1-small.jpg" srcset="image/turtle1-medium.jpg 2x,image/turtle1-large.jpg 3x">
                    ...
                    <figure class="right" id="explanation2">
                        <img class="rounded" alt="altered turtle" src="image/turtle2-small.jpg" srcset="image/turtle2-medium.jpg 2x,image/turtle2-large.jpg 3x">
                ...
                <section id="sort">
                    ...
                    <table class="table">
                        ...
                        <tr class="rowEven">
                            <th>Pictures</th>
                            <td>
                                <img class="rounded" alt="compost" src="image/compost-small.jpg" srcset="image/compost-medium.jpg 2x,image/compost-large.jpg 3x">
                                <p>compost is the trash that can be decayed. <a href="https://www.gardeningknowhow.com/composting/basics/composting-basics.htm" target="_blank"><cite>gardeningknow.com</cite></a>
                                </p>
                            </td><!--https://www.gardeningknowhow.com/composting/basics/composting-basics.htm-->
                            <td>
                                <img class="rounded" alt="recycle" src="image/recycle_plastic-small.jpg" srcset="image/recycle_plastic-medium.jpg 2x,image/recycle_plastic-large.jpg 3x">
                                <p>recycle is the trash that can be converted. <a href="https://www.forgerecycling.co.uk/blog/why-cant-all-plastic-be-recycled/" target="_blank"><cite>forgerecycling.co.uk</cite></a>
                                </p>
                            </td><!--https://www.forgerecycling.co.uk/blog/why-cant-all-plastic-be-recycled/-->
                            <td>
                                <img class="rounded" alt="landfill" src="image/landfill-small.jpeg" srcset="image/landfill-medium.jpeg 2x,image/landfill-large.jpeg 3x">
                                <p>landfill is the trash that can be neither decayed nor converted. <a href="https://www.businessinsider.com/unwashed-recyclables-go-to-landfill-2015-9" target="_blank"><cite>businessinsider.com</cite></a>
                                </p>
